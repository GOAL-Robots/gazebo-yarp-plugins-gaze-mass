...
std::string WorldInterfaceServerImpl::makeSphere(const double mass ,const double radius, const GazeboYarpPlugins::Pose& pose, const GazeboYarpPlugins::Color& color,const std::string& frame_name , const std::string& object_name,const bool gravity_enable , const bool collision_enable )
{
  return proxy->makeSphere(mass,radius, pose, color,frame_name,object_name,gravity_enable, collision_enable);
}

std::string WorldInterfaceServerImpl::makeBox(const double mass, const double width, const double height, const double thickness, const GazeboYarpPlugins::Pose& pose, const GazeboYarpPlugins::Color& color,const std::string& frame_name , const std::string& object_name,const bool gravity_enable , const bool collision_enable )
{
  return proxy->makeBox(mass, width, height, thickness, pose, color,frame_name,object_name,gravity_enable, collision_enable);
}

std::string WorldInterfaceServerImpl::makeCylinder(const double mass ,const double radius, const double length, const GazeboYarpPlugins::Pose& pose, const GazeboYarpPlugins::Color& color,const std::string& frame_name , const std::string& object_name,const bool gravity_enable , const bool collision_enable )
{
  return proxy->makeCylinder(mass, radius, length, pose, color,frame_name,object_name,gravity_enable, collision_enable);
}
